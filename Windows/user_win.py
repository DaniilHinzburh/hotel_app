...
class User_Win(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.table_1.setStyleSheet("QTableWidget {color: DarkBlue;} QTableWidget::item {font-weight: bold;}")
        ...
        self.table_2.setStyleSheet("QTableWidget {color: DarkBlue;} QTableWidget::item {font-weight: bold;}")
        ...
        self.table_3.setStyleSheet("QTableWidget {color: DarkBlue;} QTableWidget::item {font-weight: bold;}")
        ...
        self.table_4.setStyleSheet("QTableWidget {color: DarkBlue;} QTableWidget::item {font-weight: bold;}")
